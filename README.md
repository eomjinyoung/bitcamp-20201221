...
- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 12-a. 자료 구조 다루기 III : 스택 구현과 사용(계속)
...
- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 21-e. 데이터 관리 서버 만들기 : 파일 및 데이터 처리 기능을 서버로 이전(계속)
...
- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 21-f. 데이터 관리 서버 만들기 : 드라이버 객체 도입(계속)
...
- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 22-b. 데이터 관리를 DBMS에게 맡기기 : SQL 삽입 공격과 자바 시큐어 코딩(계속)
    - 22-c. 데이터 관리를 DBMS에게 맡기기 : 무결성 제약 조건 및 트랜잭션

## 66일차(2021-03-29,월)

- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 22-c. 데이터 관리를 DBMS에게 맡기기 : 무결성 제약 조건 및 트랜잭션(계속)
...
- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 23-a. 데이터 처리 코드를 캡슐화하기 : DAO 클래스 도입(계속)
...
- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 24-a. DB 프로그래밍을 더 쉽고 간단히 하는 방법 : Mybatis 퍼시스턴스 프레임워크 도입(계속)
    - 24-b. DB 프로그래밍을 더 쉽고 간단히 하는 방법 : Mybatis의 기타 기능 활용

## 74일차(2021-04-08,목)

- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 24-b. DB 프로그래밍을 더 쉽고 간단히 하는 방법 : Mybatis의 기타 기능 활용(계속)
...
- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 25-b. 비즈니스 로직 분리하기 : 서비스 객체의 도입(계속)
    - 25-c. 비즈니스 로직 분리하기 : 서비스 객체를 인터페이스와 구현체로 분리

## 76일차(2021-04-12,월)

- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 26-a 단계: 객체 생성을 자동화하기 : Java Proxy를 이용한 DAO 구현체 자동 생성
    - 26-b 단계: 객체 생성을 자동화하기 : .propertis 파일을 이용한 Command 구현체 자동 생성
    - 26-c 단계: 객체 생성을 자동화하기 : 애노테이션을 이용한 Command 구현체 자동 생성

## 77일차(2021-04-13,화)

- 리플렉션 API 사용법(com.eomcs.reflect)
    - ex01 : 클래스 로딩과 인스턴스 생성
    - ex02 : 클래스 정보 알아내기
    - ex03 : 메서드 정보 알아내기 및 호출하기
    - ex04 : 생성자 정보 알아내기 및 호출하기
    - ex05 : 파라미터와 리턴 타입 정보 알아내기
    - ex06 : Proxy 객체를 이용하여 인터페이스 구현체 만들기

## 78일차(2021-04-14,수)

- 팀 프로젝트
    - 팀 별 프로젝트 후보 주제에 대한 UI 프로토타입 작성 및 발표 준비
    - 프로젝트 후보 주제 발표(팀 당 2개)

## 79일차(2021-04-15,목)

- 애노테이션 문법 사용법(com.eomcs.annotation)
    - 애노테이션을 정의하고 사용하는 방법
- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 27-a 단계: 애플리케이션을 클라이언트/서버 구조로 변경하기 : Stateful 방식의 통신 프로젝트 준비

## 80일차(2021-04-16,금)

- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 27-b 단계: 애플리케이션을 클라이언트/서버 구조로 변경하기 : 스레드풀 적용

## 81일차(2021-04-19,월)

- 스레드풀 클래스 사용법(com.eomcs.concurrent)
    - ExecutorService 클래스 사용법
- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 27-c 단계: 애플리케이션을 클라이언트/서버 구조로 변경하기 : 자바에서 제공하는 스레드풀 사용하기
    - 27-d 단계: 애플리케이션을 클라이언트/서버 구조로 변경하기 : PMS 코드를 C/S로 분리

## 82일차(2021-04-20,화)

- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 27-d 단계: 애플리케이션을 클라이언트/서버 구조로 변경하기 : PMS 코드를 C/S로 분리(계속)
    - 세션(Session) 다루기 : 로그인/로그아웃 구현 + 세션 도입

## 83일차(2021-04-21,수)

- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 27-e 단계: 애플리케이션을 클라이언트/서버 구조로 변경하기 : 멀티스레드 환경에서 트랜잭션 제어

## 84일차(2021-04-22,목)

- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 27-e 단계: 애플리케이션을 클라이언트/서버 구조로 변경하기 : 멀티스레드 환경에서 트랜잭션 제어(계속)
    - 27-3 단계 + 28-a 단계
    - 28-b 단계: 세션(Session) 다루기 : Stateless 통신 구현
    - 28-c 단계: 세션(Session) 다루기 : Stateless 통신에서 세션 유지 방법

    
## 85일차(2021-04-23,금)

- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 29-a 단계: `Chain of Responsibility` 디자인 패턴 : 프로젝트에 적용
    - 29-b 단계: `Chain of Responsibility` 디자인 패턴 : 필터 객체 자동 로딩 및 실행
    - 29-c 단계: `Chain of Responsibility` 디자인 패턴 : 로그인 검사를 필터로 분리
    - 30-a 단계: 웹 애플리케이션 서버 아키텍처로 전환하기 : Servlet 기술 도입
    - 30-b 단계: 웹 애플리케이션 서버 아키텍처로 전환하기 : `ServerApp`을 톰캣 서버로 대체하기

## 86일차(2021-04-26,월)

- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 30-b 단계: 웹 애플리케이션 서버 아키텍처로 전환하기 : `ServerApp`을 톰캣 서버로 대체하기(계속)
    - 30-c 단계: 웹 애플리케이션 서버 아키텍처로 전환하기 : `Command` 구현체를 `Servlet` 구현체로 바꾸기

## 87일차(2021-04-27,화)

- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 30-c 단계: 웹 애플리케이션 서버 아키텍처로 전환하기 : `Command` 구현체를 `Servlet` 구현체로 바꾸기(계속)
    - 30-d 단계: 웹 애플리케이션 서버 아키텍처로 전환하기 : 웹 애플리케이션 서버 아키텍처로 전환하기 : 웹 애플리케이션 배치를 자동화 하기 

## 88일차(2021-04-28,수)

- 웹프로그래밍(eomcs-java-web)
    - src-01 : 웹 프로젝트를 만들고 이클립스를 이용하여 톰캣 서버에 자동으로 배치하는 방법
    - JavaEE/WAS/Servlet API 등에 대한 소개
- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 30-d 단계: 웹 애플리케이션 서버 아키텍처로 전환하기 : 웹 애플리케이션 서버 아키텍처로 전환하기 : 웹 애플리케이션 배치를 자동화 하기(계속)
...
- DB 모델링
    - DB 모델링 방법 : 물리 모델링, 포워드 엔지니어링
- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 31-a 단계: Servlet 기술 활용하기 : GET/POST 요청 구분과 HTML 도입하기 
...
- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 31-a 단계: Servlet 기술 활용하기 : GET/POST 요청 구분과 HTML 도입하기(계속)
    - 31-b 단계: Servlet 기술 활용하기 : 필터와 리스너 활용
    - 31-c 단계: Servlet 기술 활용하기 : 리프래시와 리다이렉트 활용

## 98일차(2021-05-13,목)

- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 31-d 단계: Servlet 기술 활용하기 : 포워딩과 인클루딩 활용
    - 31-e 단계: Servlet 기술 활용하기 : 쿠키와 세션 활용

## 99일차(2021-05-14,금)

- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 31-f 단계: Servlet 기술 활용하기 : 서블릿 예외 처리
    - 32-a 단계: MVC 아키텍처로 전환하기 : JSP를 활용하여 view 컴포넌트 분리하기

## 100일차(2021-05-17,월)

- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 32-a 단계: MVC 아키텍처로 전환하기 : JSP를 활용하여 view 컴포넌트 분리하기(계속)
    - 32-b 단계: MVC 아키텍처로 전환하기 : JSP 엘리먼트와 JSP 액션 태그 사용하기
    - 32-c 단계: MVC 아키텍처로 전환하기 : EL(Expression Language) 사용하기
...
- 웹프로그래밍(eomcs-java-web)
    - src-02/main/webapp/css : CSS 사용법
