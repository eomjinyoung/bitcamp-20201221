...
- 학습 목표 달성 확인 목록
    ...
    - [] DAO를 구현할 수 있는가?
- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 30-a 단계: 데이터 관리를 DBMS에게 맡기기 : JDBC API 사용하기
    - 30-b 단계: 데이터 관리를 DBMS에게 맡기기 : SQL 삽입 공격과 자바 시큐어 코딩

## 65일차(2021-03-26,금)

- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 30-b 단계: 데이터 관리를 DBMS에게 맡기기 : SQL 삽입 공격과 자바 시큐어 코딩(계속)
    - 30-c 단계: 데이터 관리를 DBMS에게 맡기기 : 무결성 제약 조건 다루기

## 66일차(2021-03-29,월)

- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 30-c 단계: 데이터 관리를 DBMS에게 맡기기 : 무결성 제약 조건 다루기(계속)
    - 30-d 단계: 데이터 관리를 DBMS에게 맡기기 : 무결성 제약 조건 다루기 II

## 67일차(2021-03-30,화)

- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 31-a 단계: 데이터 처리 코드를 별도의 클래스로 분리하기 : DAO 클래스 도입

## 68일차(2021-03-31,수)

- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 31-a 단계: 데이터 처리 코드를 별도의 클래스로 분리하기 : DAO 클래스 도입(계속)
...
- Mybatis Persistence 프레임워크(com.eomcs.mybatis)
    - ex05 : 테이블 조인 다루기
- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 32-a 단계: DB 프로그래밍을 더 쉽고 간단히 하는 방법 : Mybatis 퍼시스턴스 프레임워크 도입

## 73일차(2021-04-07,수)

- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 32-a 단계: DB 프로그래밍을 더 쉽고 간단히 하는 방법 : Mybatis 퍼시스턴스 프레임워크 도입(계속)
    - 32-b 단계: DB 프로그래밍을 더 쉽고 간단히 하는 방법 : Mybatis 기타 기능 활용하기

## 74일차(2021-04-08,목)

- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 32-b 단계: DB 프로그래밍을 더 쉽고 간단히 하는 방법 : Mybatis 기타 기능 활용하기(계속)
    - 32-c 단계: DB 프로그래밍을 더 쉽고 간단히 하는 방법 : Mybatis에서 트랜잭션 다루기
    - 33-a 단계: 비즈니스 로직 분리하기 : DAO에서 트랜잭션을 다룰 때의 한계
    - 33-b 단계: 비즈니스 로직 분리하기 : 서비스 객체의 도입

## 75일차(2021-04-09,금)

- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 33-b 단계: 비즈니스 로직 분리하기 : 서비스 객체의 도입(계속)
    - 33-c 단계: 비즈니스 로직 분리하기 : 서비스 객체를 인터페이스와 구현체로 분리하기
...
- 실습 프로젝트 : mini-pms(프로젝트 관리 시스템)
    - 34-a 단계: 객체 생성을 자동화하기 : 프록시 패턴을 이용한 DAO 구현체 자동 생성